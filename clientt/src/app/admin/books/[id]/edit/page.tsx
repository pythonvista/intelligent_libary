...
const EditBookPage: React.FC = () => {
  ...
  const fetchBook = useCallback(async () => {
    ...
    try {
      ...
      setFormData({
        ...
        totalCopies: book.totalCopies ? book.totalCopies.toString() : '1',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await booksAPI.updateBook(params.id as string, bookData);
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Update book details below</p>
          </div>
        </div>
